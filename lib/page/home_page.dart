...
import 'package:rodriguez/data/category_model.dart';
import 'package:rodriguez/data/plant_data.dart';
import 'package:rodriguez/page/details_page.dart';
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white,
                      border: Border.all(color: Color(0xff51370e)),
                      boxShadow: [
                        BoxShadow(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (selectId == i)
                            const CircleAvatar(
                              radius: 3,
                              backgroundColor: Color(0xff693902),
                            )
                        ],
                      ),
                    )
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          bottom: 20,
                          child: CircleAvatar(
                            backgroundColor: Color(0xff517941),
                            radius: 15,
                            child: Image.asset(
